...
// exit;
    if ($pet) {
        ...
        $stmt_similar = $conn->prepare("SELECT id, pet_name, pet_category, price, city, state, photo, gender, size, age, breeds, description FROM pets WHERE pet_category = :category AND id != :id AND status = 'available' LIMIT 10");
