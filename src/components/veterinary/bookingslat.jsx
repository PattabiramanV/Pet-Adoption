...
function BookingSlot() {
    ...
    //         try {
    //             const data = await fetchDoctorId(); // Ensure fetchDoctorId is a defined async function
    //             // const doctorId = data.doctorId; // Adjust this based on your actual data structure
...
// console.log('doctorId',doctorId);
    ...
    const handleSubmit = async () => {
        ...
        //     notification.error({
        //         message: 'Error',
        //         description: 'Failed to save slots.',
        //     });
