    ...
    <div className="doctor-more-info-container">
      <div className="doctor-details">
        <div className="doctor-pic">
          <img src={doctor.profile_img} className="doctor-img" alt="Doctor Picture" />
        </div>
        <div className="doctor-info">
          ...
          <div className="div-experience-doctormoreinfo dot">
            ...
            <h3>{doctor.experience ? `${doctor.experience} years` : 'Not available'}</h3>
          </div>
          
          
          <div className="button-group-doctormoreinfo">
            <button className="contact-doctor-btn doctor-btn">Contact Doctor</button>
            <button onClick={() => window.history.back()} className="doctor-btn">Go Back</button>
          </div>
        </div>
      </div>
  </div> 
