        ...
        <div className="popup-content">
            ...
            <div className="popup-text">
                ...
                <div className="div_pop_btn">
                  <button  className="popup-btn">{location.photos && !location.photo && !location.profile_img && <Link to={`/pethostel/booking/${location.id}`}  style={{color:"black" }} >Book Now</Link>  }
                    {location.profile_img && !location.photos && !location.photo &&<Link to={"/petgrooming"}  style={{color:"black" }} >Book Now</Link>  }      
                    {location.photo && !location.photos && !location.profile_img && <Link to={"/PetGallery"}  style={{color:"black" }} >Book Now</Link>  }         </button>
                </div>
            </div>
        </div>
    </div>
